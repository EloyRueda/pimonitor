...
[ Sistema Operativo ] ──> Ejecuta Systemd
│
└──> [ Usuario: pimonitor ] (Sin Shell / No-Sudo)
│
└──> Trabaja exclusivamente en:
├── /pimonitor/ (Código y BD)
└── /var/log/pimonitor/ (Logs)
...
sudo chown -R pimonitor:pimonitor /etc/pimonitor

---

🚀 Instalación y Puesta en Marcha
Clonar el repositorio dentro de la carpeta del USB:
...
Crea un archivo .env en la raíz (ignorado en Git por seguridad) con tus claves:
...
Crea el archivo de configuración del demonio:
